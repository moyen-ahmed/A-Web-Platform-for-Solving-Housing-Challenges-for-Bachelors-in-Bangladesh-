...
<body>
<header>
<h1><a href="home.php" style="color: #fff; text-decoration: none;">Tolet_for_bachelor</a></h1>
    <div class="profile-menu">
        <!-- <a href="insert_housekeeper.php" class="btn btn-success me-2">Insert Housekeeper</a> -->
